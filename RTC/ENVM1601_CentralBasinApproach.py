...
class Central_Basin_Approach():
    ...
    def create_CBA_model(self, storage):
        """
        ...
        storage : LIST
            ...
            threshold in the form of
            storage = [[n_1, 1], [n_2, 1.5] ... [n_n, t]].
    ...
    def run_CBA_model(self, wwtp_capacity, inflow, time_step):
        """
        Runs the Central Basin Approach Model
        ...
        time_step: Float
            The timestep in seconds at which the results are reported. This is to 
        ...
        for inflow_t in inflow:
            ...
            if inflow_t*time_step > wwtp_capacity*time_step + available_storage:
                ...
                total_cso_volume += (inflow_t*time_step -
                                     ...
                                     available_storage)
                cso_tracked.append((inflow_t*time_step -
                                     wwtp_capacity*time_step -
                                     available_storage))
                ...
                cso_tracked.append(0)
            storage_tracked.append(available_storage) #record the current 
            #available storage
        return total_cso_volume, storage_tracked, cso_tracked
